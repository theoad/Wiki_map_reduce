...
public final class DataFilter {
     ...
     * encoding.
     * {@link OutputStreamWriter#OutputStream} and
    ...
    public static void main(final String[] args) throws IOException {
        ...
        try (
//                PrintWriter printWriter = new PrintWriter(new OutputStreamWriter(new FileOutputStream("output")), true);
...
//        throw new RuntimeException("To be implemented");
        return !(columns[1].equals(SPECIAL_PAGES[0])
                || columns[1].equals(SPECIAL_PAGES[1])
                || columns[1].equals(SPECIAL_PAGES[2]));
    }
